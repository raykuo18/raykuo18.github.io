...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "Research and engineering projects across vision-language models, language modeling, ML accelerators, and applied AI.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Talks",
          description: "Course presentations, guest lectures, posters, and teaching assistantships.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Academic CV. The PDF download icon at top right links to the latest LaTeX-rendered version (compact, optimized for print and recruiter PDF screens).",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-vlm-ssm-vision-encoders",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-toward-tokenizer-free-chinese-lms",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-icassp-2024-transmix",
          title: 'ICASSP 2024 — TransMix',
          description: "Cross-domain augmentation for limited-supervision foot-ulcer segmentation. ICASSP 2024 (equal first author).",
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_project/";
            },},{id: "projects-mlisa-aie-backend-vck5000",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-adaptive-chess-tutor",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-ai-powered-beamforming-antenna",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-stylus-trajectory-cnn",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/ray_kuo_cv.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%61%79%6B%75%6F.%73%6A@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/raykuo18", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/raykuo18", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=0NqkDTcAAAAJ", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0004-7787-7414", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://huggingface.co/raykuo188", "_blank");
        },
      },{
      id: 'light-theme',
